...
@XmlType(
    ...
    propOrder = {"realmCode", "typeId", "templateId", "id", "code", "effectiveTime", "performer"})
public class POCDMT000040ServiceEvent {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link POCDMT000040Performer1 }
   */
