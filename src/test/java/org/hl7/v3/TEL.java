 ...
 * or service) mediated by telecommunication equipment. The address is specified as a URL qualified
...
public class TEL extends URL {
   ...
   * there is not a <CODE>set</CODE> method for the useablePeriod property.
   *
