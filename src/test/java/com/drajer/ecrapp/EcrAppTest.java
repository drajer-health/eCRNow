...
public class EcrAppTest {
    ...
    public void test1(){
        ...
        try{
            restTemplate.exchange("http://localhost:8081/api/test2?waitFor=9700", HttpMethod.GET, null, String.class);
    ...
    public void testNegative1(){
        Assertions.assertNotNull(restTemplate);
        try{
            restTemplate.exchange("http://localhost:8081/api/test2?waitFor=10000", HttpMethod.GET, null, String.class);
        }catch (ResourceAccessException e){
