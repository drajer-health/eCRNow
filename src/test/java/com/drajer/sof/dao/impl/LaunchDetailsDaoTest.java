...
public class LaunchDetailsDaoTest {
	...
	@Autowired
	private LaunchDetailsDaoImpl launchDetailsDaoImpl;
	...
	public void getLaunchDetailsByPatientAndEncounter() throws JsonParseException, JsonMappingException, IOException
	{
		...
		LaunchDetails retrievedLaunchDetails = launchDetailsDaoImpl.getLaunchDetailsByPatientAndEncounter(patientID, encounterID, fhirServerUrl);
	...
	public void getLaunchDetailsByState() throws JsonParseException, JsonMappingException, IOException
	{
		...
		LaunchDetails retrievedLaunchDetails = launchDetailsDaoImpl.getLaunchDetailsByState(savedLaunchDetails.getLaunchState());
