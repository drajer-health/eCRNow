...
public class BsaServiceUtilsTest {
  ...
  public void getFhirPathVariableString() {
    ...
    String acutalPathVariable =
        bsaServiceUtils.getFhirPathVariableString("plandefinition-cancer-example");
    assertEquals(expectedPathVariable, acutalPathVariable);
  }
  ...
  public void filterResources() {
    ...
    DataRequirement profileFilter = dr.addProfile("837567");
    ...
    Set<Resource> filtered = BsaServiceUtils.filterResources(resources, dr, karProcessingData);
  ...
  public void hasCdaData() throws Exception {
    ...
    BundleEntryComponent entry = new BundleEntryComponent().setResource(messageHeader);
    BundleEntryComponent entry1 = new BundleEntryComponent().setResource(messageHeader);

    Bundle bundle = new Bundle().setType(BundleType.MESSAGE).addEntry(entry);
  ...
  public void testHasCdaData() {
    Patient patient = new Patient();
    Boolean hasCdaData = BsaServiceUtils.hasCdaData(patient);
    assertFalse(hasCdaData);
  }
}
