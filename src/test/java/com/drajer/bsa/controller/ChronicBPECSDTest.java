...
public class ChronicBPECSDTest extends BaseKarsTest {
  ...
  public static Collection<TestCaseInfo> data() {
    return Arrays.asList(
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure", "bp-report-denom-exc-in", true, 1, 1, 1, 0),
        new TestCaseInfo("ChronicDSControllingBloodPressure", "bp-report-ip-in", true, 1, 1, 0, 0),
        new TestCaseInfo("ChronicDSControllingBloodPressure", "bp-report-ip-out", true, 0, 0, 0, 0),
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure", "bp-report-numer-in", true, 1, 1, 0, 1),
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure", "bp-report-numer-out", true, 1, 1, 0, 0),
        new TestCaseInfo(
        ...
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure", "bp-trigger-condition-missing", false, 0, 0, 0, 0),
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure", "bp-trigger-condition-out", true, 0, 0, 0, 0),
        new TestCaseInfo(
            "ChronicDSControllingBloodPressure",
            "bp-trigger-in",
            true,
