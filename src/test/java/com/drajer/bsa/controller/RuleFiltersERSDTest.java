...
@TestPropertySource(properties = { "kar.directory=src/test/resources/Bsa/Scenarios/kars/rulefilters" })
public class RuleFiltersERSDTest extends BaseKarsTest {
    ...
    public static Collection<TestCaseInfo> data() {
        return Arrays.asList(new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-all-criteria-missing", false),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-all-criteria-out", false),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-condition-in", false),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-completed-in", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-completed-out", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-in", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-inprogress-in", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-inprogress-out", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-encounter-immunization-in", true),
                ...
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-medicationadministration-in", true),
                new TestCaseInfo("PlanDefinition_eRSD_Instance_Example", "ex-trigger-medicationorder-in", true),
