package com.drajer.bsa.ehr.ehr.customizations;

import static org.junit.Assert.*;

import ca.uhn.fhir.rest.client.interceptor.AdditionalRequestHeadersInterceptor;
import com.drajer.bsa.ehr.customizations.SampleEhrHeaderInterceptorImpl;
...
public class SampleEhrHeaderInterceptorImplTest {
  ...
  public void testGetHeaderInterceptor_WithInvalidJson() {
    String ehrContext = "{\"Authorization\":\"Bearer token123\", \"Custom-Header\":}";
