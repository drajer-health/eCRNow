...
public class ITBaseCustom extends BaseIntegrationTest {
	...
	public ITBaseCustom(String testCaseId, Map<String, String> testData, Map<String, ?> resourceMapping,
	...
	private void saveHealtcareSetting(String healthCareSettingsFile) throws IOException {
		...
		restTemplate.exchange(createURLWithPort("/api/healthcareSettings"), HttpMethod.POST, entity, String.class);
	}
}
