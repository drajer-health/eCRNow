...
public class PeriodicUpdateEicrActionTest {
	...
	public void testExecute_RelatedActionWithDuration() throws Exception {
	   ...
	   assertEquals(periodicUpdateJobStatus.SCHEDULED, JobStatus.SCHEDULED); 
	...
	public void testExecute_NoDurationJobScheduledTriggerMatch() throws Exception {
		...
		ApplicationUtils.saveDataToFile(eq("**** Printing Eicr from Periodic Update EICR ACTION ****"), anyString());
				
		assertEquals(periodicUpdateJobStatus.COMPLETED, JobStatus.COMPLETED); 
