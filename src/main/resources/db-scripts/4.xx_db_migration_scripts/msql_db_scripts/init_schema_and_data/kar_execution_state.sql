...
BEGIN TRY
    ...
    DECLARE
        @old_table NVARCHAR(128) = 'kar_execution_state',
        @new_table NVARCHAR(128) = 'kar_execution_state_v2',
    ...
    BEGIN
        ...
        CREATE TABLE dbo.' + QUOTENAME(@new_table) + N' (
            ...
            nc_id UNIQUEIDENTIFIER NOT NULL,
            nc_fk UNIQUEIDENTIFIER NULL,               -- Can be updated with FK later
            hs_fhir_server_url VARCHAR(8000) NOT NULL,
            kar_unique_id VARCHAR(8000) NOT NULL,
            action_status VARCHAR(8000) NULL
        );
        ';
