...
public class Authorization {
	...
	public String createAuthUrl(LaunchDetails authDetailsObject,ClientDetails clientDetails, Integer state) {
	...
	public JSONObject getAccessToken(LaunchDetails tokenDetails) {
		...
		try {
			...
			ResponseEntity<?> response = restTemplate.exchange(tokenDetails.getTokenUrl(), HttpMethod.POST, entity,
					Response.class);
			...
			logger.error("Error in Getting the AccessToken for the client: " + tokenDetails.getClientId());
		}
