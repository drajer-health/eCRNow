...
public class FhirGeneratorConstants {
  ...
  public static final String VITAL_SIGNS_SECTION_LOINC_CODE_DISPLAY = "Vital signs note";
  public static final String SOCIAL_HISTORY_SECTION_LOINC_CODE = "29762-2";
  public static final String SOCIAL_HISTORY_SECTION_LOINC_CODE_DISPLAY = "Social history note";
  public static final String PREGNANCY_SECTION_LOINC_CODE = "90767-5";
  public static final String PREGNANCY_SECTION_LOINC_CODE_DISPLAY = "Pregnancy summary Document";
  ...
  public static final String EMERGENCY_OUTBREAK_SECTION_LOINC_CODE_DISPLAY = "Public health Note";
