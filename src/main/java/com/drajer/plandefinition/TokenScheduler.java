...
import com.drajer.plandefinition.model.Response;
...
public class TokenScheduler {
	...
	public void scheduleJob(AuthTokenDetails authDetails) {
	...
	class RunnableTask implements Runnable {
		...
		public AuthTokenDetails authDetails;

		public RunnableTask(AuthTokenDetails authDetails) {
	...
	private JSONObject getAccessToken(AuthTokenDetails authDetails) {
	...
	private void updateAccessToken(AuthTokenDetails authDetails, JSONObject tokenResponse) {
		AuthTokenDetails existingAuthDetails = new AuthTokenDetails();
		try {
	...
	private void getResourcesData(AuthTokenDetails authDetails) {
