...
public class CdaResultGenerator {
  ...
  public static void getTableValuesForObservationWithComponents(
    ...
    bodyvals.put(CdaGeneratorConstants.LABTEST_TABLE_COL_1_BODY_CONTENT, StringEscapeUtils.escapeXml11(obsDisplayName));

    // Get Value String
    if (val.isEmpty()) val = CdaGeneratorConstants.UNKNOWN_VALUE;
    bodyvals.put(CdaGeneratorConstants.LABTEST_TABLE_COL_2_BODY_CONTENT, StringEscapeUtils.escapeXml11(val));
