...
public class BsaFhirPathCondition extends BsaCondition {
  ...
  public CqlProcessor getExpressionEvaluator() {
    return ((FhirPathProcessor) this.getConditionProcessor()).newEvaluator();
  }

  public void setExpressionEvaluator(Supplier<CqlProcessor> factory) {
